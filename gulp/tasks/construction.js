...
const watchsasschanges = function () {
  gulp.watch(['./src/**/*.sass', '!./src/lab/**/*'], { events: 'all' }, sassfunction)
}
...
const watchjs = function () {
  gulp.watch(['./src/**/*.js', '!./src/third-party/../*', '!./src/lab/**/*'], { events: 'all' }, jsfunction)
}
//PHP function
...
const watchphp = function () {
  gulp.watch(['./src/**/*.php', '!./src/third-party/../*', '!./src/lab/**/*'], { events: 'all' }, phpfunction)
}
...
const imgfunction = function () {
  return gulp.src(['./src/**/*.svg', './src/**/*.jpg', './src/**/*.png', './src/**/*.gif', '!./src/**/includes/**/*', '!./src/common/svg-sprite/*', '!./src/lab/**/*'])
    .pipe(
      cache(
        imagemin([
          imgCompress({
...
const watchimg = function () {
  gulp.watch(['./src/**/*.svg', './src/**/*.jpg', './src/**/*.png', './src/**/*.gif', '!./src/**/includes/**/*', '!./src/lab/**/*'], { events: 'all' }, imgfunction)
}
